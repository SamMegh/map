...
export const defaultMaps: MapData[] = [
...
},
  {
    ...
    teams: ["Marines", "OpFor"],
    address: "Basra, Iraq",
    supportedModes: ["SND", "HP", "DOM", "TDM", "LINEUPS"],
    objectives: {
      SND_A: { x: 0.41, y: 0.13 },
  ...
  },
  {
    ...
    teams: ["Special Forces", "Guerrilla Squad"],
    address: "Spain",
    supportedModes: ["SND","TDM", "LINEUPS"],
    objectives: {
      SND_A: { x: 0.83, y: 0.58 },
      SND_B: { x: 0.26, y: 0.72 },
    },
  ...
  },
  {
    ...
    teams: ["Special Forces", "Guerrilla Squad"],
    address: "Panama",
    supportedModes: ["SND", "LINEUPS","TDM","HP"],
    objectives: {
      SND_A: { x: 0.52, y: 0.18 },
      SND_B: { x: 0.6, y: 0.63 },
    },
  ...
  },
  {
    ...
    supportedModes: ["SND","TDM", "LINEUPS","HP"],
    objectives: {
      SND_A: { x: 0.46, y: 0.85 },
      SND_B: { x: 0.3, y: 0.32 },
    },
